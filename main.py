...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    async def create_source(cls, ctx, search: str, *, loop, download=False):
        ...
        return cls(discord.FFmpegPCMAudio(source, executable="ffmpegc\\bin\\ffmpeg"), data=data, requester=ctx.author)
    ...
    async def regather_stream(cls, data, *, loop):
        ...
        return cls(discord.FFmpegPCMAudio(data['url'], executable="ffmpegc\\bin\\ffmpeg"), data=data,
                   requester=requester)
